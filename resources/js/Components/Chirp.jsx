...
// Lo que marca el tiempo desde que se comento es dayjs. Por una vez en la vida funciono correctamente!
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        {chirp.created_at !== chirp.update_at && <small className="text-sm text-gray-600"> &middot; Edited</small>}
                    </div>
